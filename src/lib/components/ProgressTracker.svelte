<script lang="ts">
	...
	import { isPangram } from '$lib/utils/pangram-utils';
	...
	function showAnswers() {
		...
		for (const word of wordsLeft) {
			...
			if (isPangram(word, $settings.pangramLength)) {
				pangrams.push(word);
			}
		}
...
<button class="show-answers-button" on:click={showAnswers}> Log Answers </button>
